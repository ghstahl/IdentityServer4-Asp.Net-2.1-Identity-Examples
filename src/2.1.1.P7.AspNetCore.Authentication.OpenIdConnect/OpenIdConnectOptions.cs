...
namespace P7.AspNetCore.Authentication.OpenIdConnect
{
    ...
    public class OpenIdConnectOptions : RemoteAuthenticationOptions
    {
        ...
        public OpenIdConnectOptions()
        {
            ...
            ClaimActions.P7MapUniqueJsonKey("sub", "sub");
            ClaimActions.P7MapUniqueJsonKey("name", "name");
            ClaimActions.P7MapUniqueJsonKey("given_name", "given_name");
            ClaimActions.P7MapUniqueJsonKey("family_name", "family_name");
            ClaimActions.P7MapUniqueJsonKey("profile", "profile");
            ClaimActions.P7MapUniqueJsonKey("email", "email");
